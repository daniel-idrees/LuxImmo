...
A generic, filled-in version of the MVI skeleton for an **Articles** list screen. Base types (`ViewState`, `ViewAction`, `ViewSideEffect`, `MviViewModel`) come from this skill's `template.md` (the *MVI* section).
